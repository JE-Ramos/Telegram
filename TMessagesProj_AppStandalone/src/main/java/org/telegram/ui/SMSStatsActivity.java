...
import je.ramos.telegram.web.R;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_SHADOW:
                    ...
                    Drawable shadowDrawable = Theme.getThemedDrawable(getContext(), je.ramos.telegram.R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, resourceProvider));
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (item.viewType == VIEW_TYPE_HEADER) {
                ...
                try {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", je.ramos.telegram.R.string.Cancel), null);
